...
--Bufferline
maps.n["<leader>x"] = { "<cmd>BufferLinePickClose<cr>"}
maps.n["<S-l>"] = { "<cmd>BufferLineCycleNext<cr>"}
maps.n["<S-h>"] = { "<cmd>BufferLineCyclePrev<cr>"}

--Rest
maps.n["<leader>b"] = { "<cmd>lua require('rest-nvim').run()<cr>"}
-- Hop
maps.n["f"] = { "<cmd>HopChar1CurrentLineAC<cr>"}
maps.n["F"] = { "<cmd>HopChar1CurrentLineBC<cr>"}
maps.n["s"] = { "<cmd>HopChar2AC<cr>"}
maps.n["S"] = { "<cmd>HopChar2BC<cr>"}
maps.n["<leader>s"] = { "<cmd>HopLineStartAC<cr>"}
maps.n["<leader>S"] = { "<cmd>HopLineStartBC<cr>"}
